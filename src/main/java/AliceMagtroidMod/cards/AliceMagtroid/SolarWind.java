...
import AliceMagtroidMod.action.common.AliceExhaustSpecificCardAction;
...
public class SolarWind extends AbstractAliceMagtroidCard {
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		...
		while (!res.isEmpty()) {
			...
			this.addToBot(new AliceExhaustSpecificCardAction(res.get(k), p.hand));
			res.remove(k);
