package AliceMod.characters;

import AliceMod.AliceMod;
import AliceMod.cards.Reiuji.Defend_Alice;
import AliceMod.cards.Reiuji.Strike_Alice;
import AliceMod.patches.enums.AbstractCardEnum;
import AliceMod.patches.ReiujiModClassEnum;
...
//		ret.add("ShowOff");
	...
	public TextureAtlas.AtlasRegion getOrb() {
		return new TextureAtlas.AtlasRegion(ImageMaster.loadImage(AliceMod.CARD_ENERGY_ORB), 0, 0, 24, 24);
	}
